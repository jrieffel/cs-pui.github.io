...
- [Connecticut College](#conn) - January 20A
- [Union College (Computer Engineering)] (#union-cpe)
...
### <a name="loyola">[P] Loyola University Maryland (Maryland)</a>
_[Excerpt] Loyola University Maryland's Department of Computer Science is hiring a tenure-track Assistant Professor in any CS discipline, although expertise in theory is a plus. PhD in CS or a related discipline is required. We are a growing department of 8 full-time faculty at a liberal arts college. Faculty teach 3 courses each in spring and fall, and have research support. We also support a data science program (BS and MS) that the successful candidate could teach in if interested. For more information about our department check out [our website](http://www.cs.loyola.edu). We are located in Baltimore, MD, which has a thriving tech scene, and many great places to live and for partners to work. Loyola’s commitment to diversity and inclusion spans the entire campus. With a newly established Office of Equity and Inclusion headed by our Chief Equity and Inclusion Officer, we are committed to providing an environment where everyone can learn, grow, and thrive._
- Review of applications will begin on **November 1, 2021** and continue until the position is filled.
- [Link to application](https://careers.loyola.edu/postings/5659)
